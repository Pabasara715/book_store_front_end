  ...
  const {
    ...
    const fetchBooks = async () => {
      try {
        ...
        const response = await axios.get<Book[]>('  https://d49b1200-8e8d-4080-b69e-2acfc9865ac6-dev.e1-eu-north-azure.choreoapis.dev/book-store-demo/bookstore-service/v1.0/books', {
          headers: {
    ...
    const addBook = async () => {
      const accessToken = await getAccessToken();
      try {
        await axios.post('  https://d49b1200-8e8d-4080-b69e-2acfc9865ac6-dev.e1-eu-north-azure.choreoapis.dev/book-store-demo/bookstore-service/v1.0/books', newBook, {
          headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + accessToken,
            "x-jwt-assertion": accessToken,
    ...
    const getBookById = async () => {
      const accessToken = await getAccessToken();
      try {
        const response = await axios.get<Book>(` https://d49b1200-8e8d-4080-b69e-2acfc9865ac6-dev.e1-eu-north-azure.choreoapis.dev/book-store-demo/bookstore-service/v1.0/books/${bookIdToGet}`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + accessToken,
            "x-jwt-assertion": accessToken,
    ...
    const updateBook = async () => {
      const accessToken = await getAccessToken();
      try {
        await axios.put(' https://d49b1200-8e8d-4080-b69e-2acfc9865ac6-dev.e1-eu-north-azure.choreoapis.dev/book-store-demo/bookstore-service/v1.0/books', updatedBook, {
          headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + accessToken,
            "x-jwt-assertion": accessToken,
    ...
    const deleteBook = async () => {
      const accessToken = await getAccessToken();
      try {
        await axios.delete(`https://d49b1200-8e8d-4080-b69e-2acfc9865ac6-dev.e1-eu-north-azure.choreoapis.dev/book-store-demo/bookstore-service/v1.0/books/${bookIdToDelete}`, {
          headers: {
            "Content-Type": "application/json",
            Authorization: "Bearer " + accessToken,
            "x-jwt-assertion": accessToken,
